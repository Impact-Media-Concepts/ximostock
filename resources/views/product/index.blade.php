...
<body class="bg-[#F3F4F8] text-[#717171] text-[14px]" style="font-family: 'Inter', sans-serif;">
    <x-header.header/>
    <div class="flex h-full pt-20 w-full">
        <div class="h-full">
            <x-sidenav.sidenav />
        </div>
        
        <div class="flex w-full pr-12">     
            <div class="flex justify-start items-start w-full"> <x-product.product-container :perPage="$perPage" :products="$products" /></div>
