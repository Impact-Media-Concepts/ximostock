...
<?php
    ...
    $sidenavButtons = [
        ...
        ['text' => 'Opslaglocaties', 'icon' => $app_url . '/images/store-location-icon.png', 'url' => '/locations', 'adminUrl' => $activeWorkspace ? '/locations?workspace=' . $activeWorkspace : '', 'id' => '8', 'slug' => 'locations'],
