...
<?php
    ...
    $sidenavButtons = [
        ...
        ['text' => 'Verkoopkanalen', 'icon' => $app_url . '/images/selling-channels-icon.png', 'url' => '/saleschannels', 'adminUrl' => $activeWorkspace ? '/saleschannels?workspace=' . $activeWorkspace : '', 'id' => '4', 'slug' => 'saleschannels'],
        ...
        ['text' => 'Opslaglocaties', 'icon' => $app_url . '/images/store-location-icon.png', 'url' => '/locations', 'adminUrl' => $activeWorkspace ? '/locations?workspace=' . $activeWorkspace : '', 'id' => '8', 'slug' => 'store-location'],
