...
<!-- checks if there was any error adding the disount to products -->
@if ($discountError)
        ...
        >
            <div class="flex items-start justify-center">
                <div class="w-[32.18rem] h-[36.56rem] flex grid justify-center rounded-md bg-white">
                    ...
                    <div id="discountItemContainer" class="w-[29.12rem] h-[14.75rem] flex-col rounded-md overflow-y-auto overflow-x-hidden max-h-[14.75rem]" style="border: 1px solid #F0F0F0;">
                        <?php if ($discountError !== null): ?>
							
							<!-- Goes through every product item which had an discountError -->
                    ...
                    <div class="discount-buttons flex items-center gap-[13.2rem] mb-[0.5rem]">
                        ...
                        <div class="flex items-center justify-end">
                            <button id="continueDiscounts" class="flex justify-center items-center w-[7.87rem] h-[2.68rem] bg-[#3DABD5] rounded-md hover:bg-[#3999BE] gap-[0.5rem]">
...
<script>
	...
	let discountErrorsContainer = document.getElementById('discountItemContainer');
    let saveButton = document.getElementById('continueDiscounts');
    ...
    document.querySelectorAll('.skip-discountWarningError-item').forEach(function(button) {
        button.addEventListener('click', function() {
			...
			if (discountErrorsContainer.getElementsByClassName('discountWarningError-item').length === 0) {
