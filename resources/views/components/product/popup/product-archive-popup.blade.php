<div
    class="cd-popup w-full h-full fixed top-0 bg-black bg-opacity-75 hidden pt-32 left-0" style="z-index: 999;"
>
    <div
        x-data="{
    ...
    >
        <div
            class="w-[2rem] cd-popup-close flex items-center relative bottom-4 left-[32rem] hover:cursor-pointer z-[1000]"
        >
            <svg
                ...
                stroke-width="2"
                stroke="gray"
                class=" cd-popup-close select-none flex items-center justify-center w-8 h-8"
            >
                <path
