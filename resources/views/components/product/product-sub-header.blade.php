...
<div class="bg-white w-full h-[3.55rem] flex justify-start items-center laptop:gap-[4.6rem] normal:gap-[4.5rem] big:gap-[6rem] enormous:gap-[6rem]"
    ...
    <div class="flex items-center big:w-full pt-[0.08rem]">
        <div class="flex relative laptop:gap-[7rem] laptop:mr-[2rem] normal:mr-[8rem] normal:h-[0.6rem] normal:gap-[17.5rem] big:w-full big:gap-[25.5rem] big:mr-[13.55rem] enormous:gap-[40rem] enormous:mr-[20rem]">
            <x-product.product-sub-header-tab :product="$products" text="Naam" />
            <x-product.product-sub-header-tab :product="$products" text="SKU" />
        </div>

        <div class="laptop:mr-[2rem] normal:mr-[5.3rem] big:mr-[13.55rem] enormous:mr-[20rem] flex justify-center items-center w-[2.75] h-[1.06] cursor-pointer">
            <x-product.product-sub-header-tab :product="$products" class="mt-[0.12rem]" text="Prijs" />
        </div>

        <div class="laptop:mr-[2rem] normal:mr-[3.85rem] big:w-full flex big:gap-[9.75rem]">
            <x-product.product-sub-header-tab :product="$products" text="Voorraad" />
        </div>
        <div class="laptop:mr-[2rem] normal:mr-[3.35rem] big:w-full flex big:gap-[9.75rem]">
            <x-product.product-sub-header-tab :product="$products" text="Verkocht" />
        </div>

        <div class="laptop:mr-[2rem] normal:mr-[3.85rem] big:w-full flex big:gap-[10.8rem]">
