...
<div class="hd:w-[98rem] uhd:w-[138rem] bg-white hd:h-[50rem] uhd:h-[57rem] rounded-t-lg create-container-border">
    <div>
        ...
        <div class="flex justify-center mt-[1.5rem] hd:gap-[2rem] uhd:gap-[42rem]">
            ...
            <div class="h-[39rem] w-[46rem] ">
                ...
                <div class="w-full flex flex-col items-center justify-start hd:max-h-[41.65rem] hd:h-[41.65rem] uhd:h-[48rem] uhd:max-h-[48rem] overflow-y-auto rounded-b-lg" style="border: 1px solid #F0F0F0">
