...
<div class="hd:w-[99rem] uhd:w-[138rem] bg-white h-[51.75rem] uhd:h-[57rem] rounded-t-lg create-container-border">
    <div>
        ...
        <div class="flex justify-center mt-[1.5rem] uhd:gap-[42rem]">
            ...
            <div class="h-[39rem] w-[46rem] ">
                ...
                <div class="w-full flex flex-col items-center justify-start h-[48rem] max-h-[48rem] overflow-y-auto rounded-b-lg" style="border: 1px solid #F0F0F0">
