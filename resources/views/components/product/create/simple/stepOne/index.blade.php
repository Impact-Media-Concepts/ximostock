    ...
    <div class="basic:w-[66rem] basic:h-[38rem] uhd:h-[61rem] hd:h-[78rem] hd:w-[93rem] uhd:w-[133rem]">
        ...
        <div class="flex uhd:gap-[20rem] hd:gap-[20rem] basic:gap-[7rem] pb-[4rem]">
            <div class="h-[9.56rem] rounded-md mt-[2rem] basic:w-[30rem] hd:w-[40rem] uhd:w-[60rem]">
                ...
                <div class="h-[7.06rem] rounded-b-lg flex justify-center items-center" style="border: 1px solid #F0F0F0;"> <x-product.create.simple.allow-backorder /> </div>
            </div>
            ...
            <div class="h-[9.56rem] rounded-md mt-[2rem] basic:w-[30rem] hd:w-[40rem] uhd:w-[60rem]">
                ...
                <div class="h-[7.06rem] rounded-b-lg flex justify-center items-center" style="border: 1px solid #F0F0F0;"> <x-product.create.simple.communi-to-channel /> </div>
            </div>
        </div>
    </div>
</div>